...
name=crossbmg4eghel_lhmerge_oci_FC-GPT_llama_tiny_canaryset_b6s4kf-sunolong_noCC_langtemp0.5_dsettemp0.5_lr1e-4wd1e-3_CosineAnnealing_warmup2500_minlr1e-6_gbs4096_mbs16_ep200
cluster=oci
if [ $cluster = oci ]; then
...
ALM_CKPT=/workspace/nemo/works/zhehuaic_works/llm/crossbmg4eghel_lhmerge_oci_FC-GPT_llama_tiny_canaryset_b6s4kf-sunolong_noCC_langtemp0.5_dsettemp0.5_lr1e-4wd1e-3_CosineAnnealing_warmup2500_minlr1e-6_gbs4096_mbs16_ep200/megatron_audio_gpt_peft--validation_bleu\\=55.377-step\\=78008-epoch\\=3.ckpt
