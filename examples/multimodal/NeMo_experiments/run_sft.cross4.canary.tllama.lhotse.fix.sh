...
VAL_MANIFESTS=[manifests/covost_v2.es_en.dev.es.40.json,/media/data/datasets/LibriSpeech/dev_clean_10.json]
VAL_Q=[/questions/asr.en.questions_gtc1a,/questions/asr.en.questions_gtc1a]
